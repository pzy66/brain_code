...
- 生成时间：`2026-04-13T21:21:01`
- 任务模式：`model-compare`
- 推荐模型族：`msetcca`
- 部署候选模型：`msetcca`
- 是否达到验收阈值：`否`
- 默认实时profile是否覆盖：`否`
- 最佳候选profile：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/profile_best_candidate.json`
- 最佳加权FBCCA profile：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/profile_best_fbcca_weighted.json`
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | msetcca | engineering-approx | 0.4545 | 0.4464 | 4.2433 | 0.0000 | 1.0000 | 2.5000 | 2.0000 | 2.2218 | N |
| 2 | ecca | engineering-approx | 0.4545 | 0.4464 | 4.2433 | 0.0000 | 0.8182 | 2.2500 | 2.0000 | 3.0264 | N |
| 3 | oacca | engineering-approx | 0.9091 | 0.8810 | 56.6566 | 0.0000 | 0.7273 | 3.3750 | 1.5000 | 2.2151 | N |
| 4 | cca | paper-faithful | 1.0000 | 1.0000 | 79.9991 | 3.0000 | 0.9091 | 3.1250 | 1.5000 | 7.7768 | N |
| 5 | fbcca | paper-faithful | 0.8182 | 0.8143 | 30.8336 | 6.0000 | 0.6364 | 5.1250 | 2.0000 | 34.8011 | N |
| 6 | legacy_fbcca_202603 | paper-faithful | 0.8182 | 0.8143 | 30.8336 | 6.0000 | 0.6364 | 5.1250 | 2.0000 | 35.1638 | N |
| 7 | tdca | engineering-approx | 0.4545 | 0.3667 | 5.6578 | 0.0000 | 0.5455 | 2.7500 | 1.5000 | 9.5074 | N |
| 8 | trca_r | engineering-approx | 0.2727 | 0.2111 | 0.0780 | 3.0000 | 0.3636 | 5.3750 | 1.5000 | 11.5895 | N |
| 9 | trca | paper-faithful | 0.3636 | 0.3083 | 1.8291 | 0.0000 | 0.0909 | 6.5000 | 1.5000 | 1.6802 | N |
| 10 | sscor | engineering-approx | 0.4545 | 0.3857 | 5.6578 | 0.0000 | 0.0000 | 6.5000 | 1.5000 | 9.3353 | N |
| 11 | itcca | engineering-approx | 0.2727 | 0.3083 | 0.0780 | 0.0000 | 0.0000 | 6.5000 | 1.5000 | 2.0853 | N |

## 图表文件

- 四分类混淆矩阵：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/figures/confusion_4class.png`
- 二分类混淆矩阵：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/figures/confusion_2class.png`
- 决策时间直方图：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/figures/decision_time_hist.png`
- 模型雷达图：`/data1/zkx/brain/ssvep/reports/20260413/model_compare_20260413_211436/figures/model_radar_async_vs_cls.png`
