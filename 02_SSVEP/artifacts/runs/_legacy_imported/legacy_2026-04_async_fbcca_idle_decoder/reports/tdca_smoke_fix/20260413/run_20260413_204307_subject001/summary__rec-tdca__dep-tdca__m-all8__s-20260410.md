...
- 生成时间：`2026-04-13T20:43:27`
- 任务模式：`model-compare`
- 推荐模型族：`tdca`
- 部署候选模型：`tdca`
- 是否达到验收阈值：`否`
- 默认实时profile是否覆盖：`否`
- 最佳候选profile：`C:\Users\P1233\Desktop\brain\brain_code\02_SSVEP\2026-04_async_fbcca_idle_decoder\profiles\reports\tdca_smoke_fix\20260413\run_20260413_204307_subject001\profile_best_candidate.json`
...
|---|---:|---:|---:|---:|
| 四分类 8/10/12/15Hz | 0.0909 | 0.0500 | 2.0000 | 3.5888 |
| 二分类 control vs idle | 0.6000 | 0.5833 | 2.0000 | 0.8715 |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | tdca | engineering-approx | 0.0909 | 0.0500 | 3.5888 | 3.0000 | 0.5455 | 2.7500 | 2.0000 | 5.2912 | N |
