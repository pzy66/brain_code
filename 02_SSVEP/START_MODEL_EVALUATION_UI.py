...
TARGET_SCRIPT = ASYNC_DIR / "ssvep_model_evaluation_ui.py"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Direct entry: multi-classifier evaluation UI."
    )
    ...
    parser.add_argument(
        ...
        default=[],
        help="forward remaining args to ssvep_model_evaluation_ui.py",
    )
    return parser
