...
DEFAULT_ARTIFACT_ROOT = THIS_DIR / "artifacts" / "runs"
DEFAULT_REPORT_DIR = DEFAULT_ARTIFACT_ROOT / "manual"
DEFAULT_DATASET_ROOT = THIS_DIR / "profiles" / "datasets"
DEFAULT_REPORT_ROOT = DEFAULT_ARTIFACT_ROOT
...
def _parse_task(raw: str) -> str:
    ...
    if value not in {"fbcca-weights", "model-compare", "fbcca-weighted-compare", "tdca-local-opt"}:
