...
OUTPUT_PROFILE_PATH = PROJECT_DIR / "artifacts" / "deployed_profiles" / "test_profile.json"
REPORT_PATH = PROJECT_DIR / "artifacts" / "runs" / "local" / "train_eval_tests" / "run_unit" / "report.json"
