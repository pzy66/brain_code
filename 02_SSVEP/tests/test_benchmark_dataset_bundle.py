...
from ssvep_core.async_fbcca_idle_standalone import TrialSpec, save_benchmark_dataset_bundle


def test_save_benchmark_dataset_bundle_writes_manifest_and_npz() -> None:
    scratch_root = PROJECT_DIR / ".tmp_test_artifacts" / "datasets_test_artifacts"
