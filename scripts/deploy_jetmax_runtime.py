...
def main(argv: list[str] | None = None) -> int:
    ...
    local_runtime = repo_root / "hybrid_controller" / "integrations" / "robot_runtime_py36.py"
    remote_runtime = f"{args.remote_root}/hybrid_controller/integrations/robot_runtime_py36.py"
    ...
    try:
        sftp = ssh.open_sftp()
        try:
            ensure_remote_dir(sftp, f"{args.remote_root}/hybrid_controller/integrations")
