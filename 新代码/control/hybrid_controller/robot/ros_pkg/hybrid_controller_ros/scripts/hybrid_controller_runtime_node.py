...
class HybridControllerRuntimeNode(object):
    def __init__(self):
        self.executor = JetMaxExecutor(
            limits={
                ...
                "teleop_min_duration": 0.10,
                "teleop_settle_sec": 0.0,
        ...
        rospy.Service("/hybrid_controller/pick_here", Trigger, self._handle_pick_here)
    ...
    def _handle_pick_here(self, _request):
        ok, message = self._submit_or_queue_action(
            "pick_here",
            self.executor.start_pick_here,
        )
